...
--la foreign key la chiave esterna servono a collegare tra di loro le tabelle
-- e mantenere il collegamento dei dati - (dipendenteid ) --> fa rioferimento dipendenti (DipendentiID) 
-- dipendenti.progettoid è una proprietà di dipendenti
/*	dipendenti.progettoid deve esistere  nella tabella progetti (progettoID)
non può assegnare un dipendente a un progetto.
...
VALUES ('Risorse Umane', 'Milano'),
	('Vendite','Napoli');

SELECT * FROM Reparti WHERE RepartoID = 2;
...
INSERT INTO Reparti (Nome, Sede) VALUES
('IT','Roma'),('HR','Milano'),('Vendite','Napoli'),('Marketing','Torino'),('Finanza','Bologna'),
('Logistica','Genova'),('Supporto','Firenze'),('Produzione','Bari'),('Ricerca','Parma'),('Qualità','Verona'),
